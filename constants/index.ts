export const developerInfo = {
    ...
    bio: 'I develop digital experiences with a strong emphasis on responsive design and user-centric principles.'
};

export const socialCardDetails = [
    {
        id: '1',
        platform: 'website (2024)',
        title: 'jeremyerikleong.com',
        url: 'https://jeremyerikleong.com',
    },
    {
        id: '2',
        platform: 'website (2022)',
        title: 'v1.jeremyerikleong.com',
        url: 'https://v1.jeremyerikleong.com',
    },
    {
        id: '3',
        platform: 'cv',
        title: "jeremyerikleong's cv",
        url: 'https://cv.jeremyerikleong.com',
    },
    {
        id: '4',
        platform: 'email',
        title: 'jeremythegreat95@gmail.com',
        url: 'mailto:jeremythegreat95@gmail.com',
    },
    {
        id: '5',
        platform: 'github',
        title: 'jeremyerikleong',
        url: 'https://github.com/jeremyerikleong',
    },
    {
        id: '6',
        platform: 'linkedin',
        title: 'jeremyerikleong95',
